...
| ------------------- | --------------------------------------------------- | ----------------- | -------: | ------: | ------------------- | --------------- | ---------- |
| gemini-3.8-flash    | `ai.x-lf.com` · `GEMINI_API_KEY`                    | chat\_completions | 1000000 | 65536  | low / medium / high | —               | —          |
| deepseek-v4.1-flash | `api.commandcode.ai` · `COMMANDCODE_API_KEY`        | chat\_completions | 1000000 | 393216 | low / high / max    | GOAT Plan       | 2026-10-11 |
| Atria-Dawn-Preview  | NewAPI `127.0.0.1:3000` · `NEWAPI_API_KEY`          | chat\_completions | 256000  | 65536  | —                   | 限时免费            | —          |
| step-5-preview      | shim `127.0.0.1:8321` → StepFun · `STEPFUN_API_KEY` | chat\_completions | 1000000 | 65536  | low / medium / high | Plus Plan       | 2026-11-19 |
